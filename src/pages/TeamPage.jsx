        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
          {teamMembers.map((member, idx) => (
            <motion.div
              ...
              className="relative bg-white rounded-xl shadow-md overflow-hidden cursor-pointer flex flex-col h-full"
            >
              {/* Gradient border on hover */}
              <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 opacity-0 hover:opacity-100 pointer-events-none transition-opacity duration-300"></div>
